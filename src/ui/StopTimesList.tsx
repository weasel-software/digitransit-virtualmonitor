...
import { formatTime, parseDaySeconds } from 'src/time';
...
const StopTimesListHeaders = ({
  ...
  <thead>
    <tr>
      ...
      {showPier ? (
        <th className="pier">{pierColumnTitle || t('pier')}</th>
      ) : null}
...
const StopTimesListHeadersTranslated = withTranslation('translations')(
  StopTimesListHeaders,
);
