...
import StopsByNameRetriever, {
  ...
  IStopWithName,
} from 'src/ui/StopsByNameRetriever';
import 'src/ui/StopSearch.css';

type IProps = {
  readonly children?: (stops: readonly IStopWithName[]) => React.ReactNode;
  ...
  public render() {
    return (
      <div id="stop-search" className="stop-selector">
        <form onSubmit={this.stopSearchSubmit} action="searchStop" method="GET">
