...
interface IConfigurationResponse {
  readonly configurations: readonly IConfiguration[];
  readonly localConfigurations: readonly IConfiguration[];
}
...
> = (
  ...
  const { ids } = props as IConfigurationRetrieverPropsWithId;
  const { name } = props as IConfigurationRetrieverPropsWithName;
