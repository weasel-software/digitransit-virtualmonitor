...
interface ITranslatedString {
  [twoLetterLanguageCode: string]: string;
}
...
export type IViewCarousel = readonly IViewCarouselElement[];
...
export interface IConfiguration extends INode {
  readonly name?: string;
  readonly displays: readonly IDisplay[];
  readonly position?: ILatLon;
}

export type IConfigurations = readonly IConfiguration[];
            ...
            {({ virtualMonitor }) => (
              ...
              >
                {(
                  ...
                  <button
                    onClick={() =>
                      createLocalConfiguration({ variables: { name: 'Derp' } })
                    }
                  >
